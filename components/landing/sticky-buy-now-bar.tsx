  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 border-t border-slate-200 bg-white/95 backdrop-blur">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-4 py-3">
        <div>
          <p className="text-xs uppercase tracking-[0.14em] text-slate-500">Limited Offer</p>
          <p className="text-sm font-bold text-slate-900">Buy now for ${Number(price).toFixed(2)}</p>
        </div>
        <a
          href="#checkout"
